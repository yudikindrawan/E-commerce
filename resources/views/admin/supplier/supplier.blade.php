      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="{{route('supplier')}}"><i class="fa fa-circle-o"></i>Data Supplier</a></li>
                ...
                <div class="col-xs-12">
                  <div class="box" style="box-shadow: 0 0 5px rgba(0,0,0,0.1); border-top:0px;">
                    <div class="box-header">
                      <div class="row">
                        <div class="col-xs-7">
                          <a href="#" class="modalCreateTrigger" data-toggle="modal" data-target="#modalCreateTrigger" ><button class="btn btn-success" >Tambah Supplier</button></a><input type="hidden" name="_token" value="{{ csrf_token() }}">
                        </div>
                      </div>
                    </div>
                    <!-- /.box-header -->
                     ...
                     <div class="box-body table-responsive">
                        <table id="example" class="table table-striped">
                          ...
                          <tr>
                            ...
                            <td> <a onClick="modalEditTriger({{$supplier->id}})" class="btn btn-primary"  data-toggle="tooltip" title="Ubah"><i class="fa fa-pencil"></i></a></td>
                          </tr>
                          @endforeach
                          </tbody>
                        </table>
...
// modal create
    ...
    event.preventDefault();
        $.ajax({
            url     : "{{route('modal_create_supplier')}}",
            method  : 'get',
