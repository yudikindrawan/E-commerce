      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="{{route('retur')}}"><i class="fa fa-circle-o"></i>Data Retur</a></li>
          </ul>
        </li>
         <li class="treeview">
          <a href="#">
                      ...
                      <div class="box-body table-responsive">
                        <table id="example" class="table table-striped">
                          ...
                          <tr>
                            ...
                            <td>{{$retur->jumlah}}</td> 
                            <td> <a onClick="modalEditTriger({{ $retur->id }})" class="btn btn-primary" data-toggle="tooltip" title="Ubah"><i class="fa fa-pencil"></i></a></td>
                          </tr>
                          @endforeach
                          </tbody>
                        </table>
