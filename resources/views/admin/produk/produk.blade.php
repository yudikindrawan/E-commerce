    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="{{route('laporan_produk')}}"><i class="fa fa-circle-o"></i>Laporan Produk</a></li>
                ...
                <div class="col-xs-12">
                  <div class="box" style="box-shadow: 0 0 5px rgba(0,0,0,0.1); border-top:0px;">
                    <div class="box-header">
                      <div class="row">
                        <div class="col-xs-7">
                           <a href="#" class="modalCreateTrigger" data-toggle="modal" data-target="#modalCreateTrigger" ><button class="btn btn-success">Tambah Produk</button></a><input type="hidden" name="_token" value="{{ csrf_token() }}">
                        </div>
                      </div>
                    </div>
                    <!-- /.box-header -->
                      <div class="box-body table-responsive">
                        <table id="example" class="table table-striped">
                          ...
                          <tr>
                            ...
                            <td>{{$produk->size->nama_size}}</td>
                            <td>{{$produk->stok}}</td>
                            <td>
                              @if ($produk->stok > 10 )
                                <span class="label label-success">{{$produk->keterangan}}</span>
                              @elseif ( $produk->stok > 0 AND $produk->stok <= 10 )
                                <span class="label label-warning">{{$produk->keterangan}}</span>
                              @else
                                <span class="label label-danger">{{$produk->keterangan}}</span>
                              @endif
                            </td> 
                            <td>{{$produk->desain}}</td>
                            <td>Rp.{{$produk->harga}}</td>  
                            <td><a onClick="modalEditTriger({{$produk->id}})" class="btn btn-primary" <a href="#" data-toggle="tooltip" title="Ubah"><i class="fa fa-pencil"></i></a></td>
                          </tr>
                          @endforeach
                          </tbody>
                        </table>
