                      ...
                      <div class="box-body">
                        <table id="example" class="table table-bordered">
                          ...
                          <tr>
                            ...
                            <td>{{$pemesanan->nama_pem_produk}}</td>
                            <td>{{$pemesanan->nama_kategori}}</td>
                            <td>{{$pemesanan->id_size}}</td>
                            <td>{{$pemesanan->jumlah}}</td>  
                            <td>{{$pemesanan->alamat}}</td>
                            <td>{{$pemesanan->email}}</td>
                            <td>{{$pemesanan->no_telp}}</td>
                            <td>{{$pemesanan->variasi}}</td>
                            <td><span class="label label-success">{{$pemesanan->status}}</span></td>
                            <td> <a onClick="modalEditTriger({{ $pemesanan->id }})" class="btn btn-primary" data-toggle="tooltip" title="Ubah"><i class="fa fa-pencil"></i></a></td>
                          </tr>
                          @endforeach
                          </tbody>
                        </table>
