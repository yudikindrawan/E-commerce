    ...
    <section class="content">
      <!-- Small boxes (Stat box) -->
       <div class="row">
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header" style="padding-bottom:auto;">
              ...
              <div class="row"> 
                <div class="col-xs-12">
                    <div class="box" style="box-shadow: 0 0 5px rgba(0,0,0,0.1); border-top:0px;">
                      ...
                      <form method="POST" class="register-form" id="register-form" action="{{route('addPemesanan')}}" enctype="multipart/form-data">
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <div class="form-input">
                                    <label for="nama_pem_produk" class="required">Nama Pemesanan Produk</label>
                                    <input type="text" name="nama_pem_produk" id="nama_pem_produk" />
                                </div>
                                 <div class="form-input">
                                    <label for="id_kategori">Kategori</label>
                                    <select name="id_kategori" id="id_kategori" class="form-control required" style="width: 100%;">
                                ...
                                <div class="form-input">
                                  ...
                                  <div class="form-group">
                                    <div class="form-input">
                                        <label for="size" class="required">XS</label>
                                        <input type="text" name="xs" id="xs" />
                                    </div>
                                    <div class="form-input">
                                        <label for="size" class="required">Small </label>
                                        <input type="text" name="s" id="s" />
                                    </div>
                                    <div class="form-input">
                                        <label for="size" class="required">Medium</label>
                                        <input type="text" name="m" id="m" />
                                    </div>
                                    <div class="form-input">
                                        <label for="size" class="required">Large</label>
                                        <input type="text" name="l" id="l" />
                                   </div>
                                    <div class="form-input">
                                        <label for="size" class="required">XL</label>
                                        <input type="text" name="xl" id="xl" />
                                    </div>
                                    <div class="form-input">
                                       <label for="size" class="required">XXL</label>
                                       <input type="text" name="xxl" id="xxl" />
                                    </div>
                                  </div>
                                   <div class="form-input">
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-input">
                                    ...
                                    <input type="text" name="variasi" id="variasi" placeholder="Contoh: Warna Putih " />
                                </div>
                                <div class="form-input">
